...
<?php if (isset($models['portal']['ariadne']['previous'])) { ?>
        	<span class="ariadne-previous" data-part="<?php echo $models['portal']['ariadne']['previous']['link'] ?>" data-id="<?php echo $models['portal']['ariadne']['previous']['id'] ?>" title="<?php echo $portal->locale->ariadne->chapter->previous.' : '.$models['portal']['ariadne']['previous']['title']; ?>"></span>
<?php } ?>
...
<?php if (isset($models['portal']['ariadne']['next'])) { ?>
        	<span class="ariadne-next" data-part="<?php echo $models['portal']['ariadne']['next']['link']; ?>" data-id="<?php echo $models['portal']['ariadne']['next']['id']; ?>" title="<?php echo $portal->locale->ariadne->chapter->next.' : '.$models['portal']['ariadne']['next']['title']; ?>"></span>
<?php } ?>
        </div>
