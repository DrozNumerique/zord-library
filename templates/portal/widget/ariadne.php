...
<?php } ?>
        	...
        	<span class="ariadne-next" data-part="<?php echo $models['portal']['ariadne']['next']['link'] ?? ''; ?>" data-id="<?php echo $models['portal']['ariadne']['next']['id'] ?? ''; ?>" title="<?php echo $this->locale('portal')->ariadne->chapter->next.' : '.(!empty($models['portal']['ariadne']['next']['flat']) ? $models['portal']['ariadne']['next']['flat'] : strip_tags($models['portal']['ariadne']['next']['title'] ?? '')); ?>">
